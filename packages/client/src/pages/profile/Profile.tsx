          ...
          <RB.Grid
            ...
            <RB.Grid item xs={12}>
              <RB.TextField
                ...
                onChange={e =>
                  setAppState(prevState => ({
                    user: { ...prevState.user, second_name: e.target.value },
                    loading: false,
                  }))
                }
                size="small"
            ...
            <RB.Grid item xs={12}>
              <RB.TextField
                ...
                value={
                  appState.user?.display_name === null
                    ? ''
                    : appState.user?.display_name
                }
                onChange={e =>
                  setAppState(prevState => ({
                    user: { ...prevState.user, display_name: e.target.value },
                    loading: false,
                  }))
                }
                size="small"
            ...
            <RB.Grid item xs={12}>
              <RB.TextField
                ...
                onChange={e =>
                  setAppState(prevState => ({
                    user: { ...prevState.user, login: e.target.value },
                    loading: false,
                  }))
                }
                size="small"
            ...
            <RB.Grid item xs={12}>
              <RB.TextField
                ...
                onChange={e =>
                  setAppState(prevState => ({
                    user: { ...prevState.user, phone: e.target.value },
                    loading: false,
                  }))
                }
                size="small"
